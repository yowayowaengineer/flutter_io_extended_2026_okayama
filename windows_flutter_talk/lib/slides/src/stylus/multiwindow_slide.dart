            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text(
                    'これまではウィンドウを増やすたびにFlutterエンジンを丸ごともう1つ起動。メモリ倍増＆ウィンドウ間の状態共有にMethodChannelが必須でした。',
                    style: TextStyle(fontSize: 24, color: Colors.white60, height: 1.6),
                  ),
                  const SizedBox(height: 16),
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style: const TextStyle(fontSize: 24, color: Colors.white70, height: 1.6),
                        ),
                        const SizedBox(height: 12),
                        Text(
                          '今のうちにAPIに触れておく価値は十分あります。',
                          style: TextStyle(fontSize: 22, color: AppColors.blue, height: 1.6),
                        ),
                      ],
                    ),
                  ),
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        ...
        const SizedBox(width: 12),
        Expanded(
          child: Text(text, style: TextStyle(fontSize: 22, color: color, height: 1.5)),
        ),
      ],
    );
  }
